...
{
    partial class AllianceFleetTableForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // itemsListView
            // 
            itemsListView.Columns.AddRange(new ColumnHeader[] { itemColumn });
            ...
            infoLabel.Size = new Size(540, 15);
            infoLabel.TabIndex = 63;
            infoLabel.Text = "Define here initial Alliance fleet deployed either at Headquarter or Yavin 4 (see General Params Id=83).";
            // 
            // entryColumn
            // 
            ...
            Name = "AllianceFleetTableForm";
            Text = "Alliance Fleet Table (CMUNAFTB.DAT)";
