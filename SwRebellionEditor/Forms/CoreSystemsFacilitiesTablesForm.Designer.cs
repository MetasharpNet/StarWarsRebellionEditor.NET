...
namespace SwRebellionEditor
{
    partial class CoreSystemsFacilitiesTablesForm
    {
        ...
        private NumericUpDown facilityType7;
        private NumericUpDown facilityPercent7;
        ...
        private void InitializeComponent()
        {
            ...
            facilityBox7 = new ComboBox();
            facilityType7 = new NumericUpDown();
            facilityPercent7 = new NumericUpDown();
            ...
            ((ISupportInitialize)facilityType7).BeginInit();
            ((ISupportInitialize)facilityPercent7).BeginInit();
            ...
            // facilityBox7
            // 
            facilityBox7.DropDownStyle = ComboBoxStyle.DropDownList;
            facilityBox7.FormattingEnabled = true;
            facilityBox7.Items.AddRange(new object[] { "Refinery", "Shipyard", "Training", "Construction", "Shield", "Laser", "Ion", "Advanced Shipyard", "Advanced Troop Training", "Advanced Construction", "Shield Generator Type II", "Laser Type II" });
            facilityBox7.Location = new Point(14, 257);
            facilityBox7.Margin = new Padding(4, 3, 4, 3);
            facilityBox7.Name = "facilityBox7";
            facilityBox7.Size = new Size(178, 23);
            facilityBox7.TabIndex = 54;
            facilityBox7.SelectionChangeCommitted += facilityBox7_SelectionChangeCommitted;
            // 
            // facilityType7
            // 
            facilityType7.Location = new Point(314, 258);
            facilityType7.Margin = new Padding(4, 3, 4, 3);
            facilityType7.Maximum = new decimal(new int[] { 255, 0, 0, 0 });
            facilityType7.Name = "facilityType7";
            facilityType7.Size = new Size(59, 23);
            facilityType7.TabIndex = 53;
            facilityType7.TabStop = false;
            facilityType7.Value = new decimal(new int[] { 255, 0, 0, 0 });
            facilityType7.ValueChanged += facilityType7_ValueChanged;
            // 
            // facilityPercent7
            // 
            facilityPercent7.Location = new Point(219, 258);
            facilityPercent7.Margin = new Padding(4, 3, 4, 3);
            facilityPercent7.Maximum = new decimal(new int[] { -1, 0, 0, 0 });
            facilityPercent7.Name = "facilityPercent7";
            facilityPercent7.Size = new Size(59, 23);
            facilityPercent7.TabIndex = 52;
            facilityPercent7.TabStop = false;
            facilityPercent7.Value = new decimal(new int[] { 100, 0, 0, 0 });
            facilityPercent7.ValueChanged += facilityPercent7_ValueChanged;
            // 
            // facilityPercent0
            // 
            ...
            // 
            // CoreSystemsFacilitiesTablesForm
            // 
            AcceptButton = Ok;
            ...
            Controls.Add(facilityBox7);
            Controls.Add(facilityType7);
            Controls.Add(facilityPercent7);
            ...
            ((ISupportInitialize)facilityType7).EndInit();
            ((ISupportInitialize)facilityPercent7).EndInit();
